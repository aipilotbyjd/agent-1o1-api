...
class SalesforceGetRecordNode extends AppNode
{
    public function type(): string
    {
        return 'salesforce.get_record';
    }

    public function name(): string
    {
        return 'Salesforce: Get Record';
    }

    public function description(): string
    {
        return 'Get a record by ID from Salesforce.';
    }
    ...
    {
        return ['type' => 'object', 'properties' => ['object' => ['type' => 'string'], 'record_id' => ['type' => 'string']], 'required' => ['object', 'record_id']];
    }
    ...
    public function execute(Run $run, array $config, array $context): array
    {
        ...
        try {
            $response = $this->sfHttp($credential)->get("/sobjects/{$config['object']}/{$config['record_id']}");
            if (! $response->successful()) {
                throw new \RuntimeException('Salesforce get_record failed: '.$response->body());
            }
