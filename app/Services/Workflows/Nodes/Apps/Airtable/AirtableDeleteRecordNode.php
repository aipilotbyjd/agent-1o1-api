...
class AirtableDeleteRecordNode extends HttpAppNode
{
    ...
    public function execute(Run $run, array $config, array $context): array
    {
        ...
        $data = $this->send($run, $credential, fn (PendingRequest $http): Response => $http->delete(self::BASE_URL."/{$config['base_id']}/{$config['table']}/{$config['record_id']}"));
