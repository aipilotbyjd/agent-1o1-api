...
class HubspotListContactsNode extends AppNode
{
    ...
    {
        return 'List contacts from HubSpot.';
    }
    ...
    public function configSchema(): array
    {
        return [
            ...
            'properties' => ['credential_id' => ['type' => 'integer'], 'limit' => ['type' => 'integer'], 'after' => ['type' => 'string'], 'properties' => ['type' => 'array']],
        ];
    }
