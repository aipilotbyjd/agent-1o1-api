...
class HubspotCreateDealNode extends HttpAppNode
{
    ...
    public function execute(Run $run, array $config, array $context): array
    {
        ...
        $data = $this->send($run, $credential, fn (PendingRequest $http): Response => $http->post(self::BASE_URL.'/crm/v3/objects/deals', ['properties' => $config['properties'] ?? []]));
