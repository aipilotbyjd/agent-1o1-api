...
class TelegramSendDocumentNode extends AppNode
{
    ...
    {
        return 'Telegram: Send Document';
    }

    public function description(): string
    {
        return 'Send a document to a Telegram chat.';
    }
    ...
    public function configSchema(): array
    {
        return [
            'type' => 'object',
            'required' => ['credential_id', 'chat_id', 'document'],
            'properties' => [
    ...
    public function execute(Run $run, array $config, array $context): array
    {
        ...
        if (! $ok) {
            throw new \RuntimeException('Telegram send_document error: '.($body['description'] ?? $response->body()));
        }
