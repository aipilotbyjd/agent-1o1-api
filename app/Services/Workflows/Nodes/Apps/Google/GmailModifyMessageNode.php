...
class GmailModifyMessageNode extends AppNode
{
    private const BASE_URL = 'https://gmail.googleapis.com/gmail/v1';

    public function type(): string
    {
        return 'gmail.modify_message';
    }
    ...
    {
        return 'Add or remove labels on a message.';
    }
    ...
    public function execute(Run $run, array $config, array $context): array
    {
        ...
        if (! $ok) {
            throw new \RuntimeException('Gmail modify_message failed: '.$response->body());
        }
