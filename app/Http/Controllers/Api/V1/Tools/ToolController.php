...
class ToolController extends Controller
{
    ...
    {
        $this->ensureToolBelongsToWorkspace($workspace, $tool);
    ...
    private function ensureToolBelongsToWorkspace(Workspace $workspace, Tool $tool): void
    {
        abort_if($tool->workspace_id !== $workspace->id, 404);
    }
}
