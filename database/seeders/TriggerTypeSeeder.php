...
class TriggerTypeSeeder extends Seeder
{
    ...
    private function catalog(): array
    {
        return [
            ...
            // GitHub — one hook URL, filtered by the X-GitHub-Event header.
            ...
            // Slack — Events API posts JSON with an event.type field.
            ...
            // Stripe — event payloads carry a top-level type field.
